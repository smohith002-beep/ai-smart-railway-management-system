...
export const LandingHero: React.FC<LandingHeroProps> = ({
  ...
  return (
    <div className="space-y-6">
      <SEOHead {...DEFAULT_PAGE_SEO.landing} />

      <section className="relative min-h-[calc(100vh-140px)] rounded-3xl overflow-hidden border border-neutral-800 bg-black flex flex-col justify-between p-8 md:p-12 shadow-2xl">
        ...
        <div className="relative z-10 max-w-4xl my-auto py-8">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <button
              ...
              className="px-8 py-3.5 rounded-xl bg-white hover:bg-neutral-200 text-black text-xs font-mono font-bold uppercase tracking-widest transition shadow-lg flex items-center gap-2 cursor-pointer"
            >
            ...
            {onOpenTrains && (
              <button
                ...
                className="px-6 py-3.5 rounded-xl bg-neutral-900 hover:bg-neutral-800 border border-neutral-700 text-white text-xs font-mono font-semibold uppercase tracking-wider transition flex items-center gap-2 cursor-pointer"
              >
                <Train className="w-4 h-4 text-neutral-400" />
                <span>TRACK TRAINS (13,198+)</span>
              </button>
            )}
            ...
            <button
              onClick={onOpenMap}
              className="px-6 py-3.5 rounded-xl bg-black/80 hover:bg-neutral-900 border border-neutral-700 hover:border-neutral-500 text-white text-xs font-mono font-semibold uppercase tracking-wider transition flex items-center gap-2 cursor-pointer"
            >
            ...
            <button
              ...
              className="px-5 py-3.5 rounded-xl bg-neutral-900/60 hover:bg-neutral-800 border border-neutral-800 text-neutral-300 hover:text-white text-xs font-mono transition cursor-pointer"
            >
              SYSTEM STATUS
            </button>
          </div>
        ...
        {/* Bottom KPI Strip */}
        <footer className="relative z-10 pt-6 border-t border-neutral-800/80 grid grid-cols-2 md:grid-cols-4 gap-4 font-mono text-xs text-neutral-400">
          <div>
